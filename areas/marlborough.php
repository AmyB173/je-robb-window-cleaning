<?php
$page_title = "Window Cleaner Marlborough | J E Robb Window Cleaning";
$page_description = "Window cleaner covering Marlborough and the surrounding villages. Careful, thorough work. Frames and sills cleaned every visit. 5-star rated, same-day reply, no contract.";
$page_canonical = "https://www.jerobb.co.uk/areas/marlborough";
...
<script type="application/ld+json">
{
  ...
  "@type": "LocalBusiness",
  "name": "J E Robb Window Cleaning - Marlborough",
  "description": "Window cleaning in Marlborough from a small, independent local business focused on careful, thorough work. Jack covers the town centre, the period houses along the High Street and back lanes, the Georgian sashes around the College, and the surrounding villages including Mildenhall, Manton, Preshute and Aldbourne.",
  "image": "<?= BUSINESS_IMAGE_URL ?>",
  "url": "https://www.jerobb.co.uk/areas/marlborough",
...
<nav aria-label="breadcrumb" class="area-breadcrumb">
  <div class="container">
    <ol class="breadcrumb mb-0 py-2 small">
      ...
      <li class="breadcrumb-item active" aria-current="page">Marlborough</li>
    </ol>
  </div>
</nav>
  ...
  <div class="container">
    <div class="row align-items-center min-vh-hero">
      ...
      <div class="col-lg-6 hero-text-col py-5 mt-3 mt-lg-0">
        ...
        <h1 class="hero-h1-split">Window Cleaner <br class="d-none d-md-block">in Marlborough</h1>
        <p class="hero-desc-split">
          A small, independent local window cleaner covering Marlborough and the surrounding villages. Frames and sills cleaned every visit, awkward corners not skipped. I reply to every enquiry the same day.
        </p>
        ...
        <div class="d-flex align-items-center mb-3">
          <img src="/assets/images/jack.webp"
            alt="Jack from J E Robb Window Cleaning - covering Marlborough"
        ...
        <div class="hero-snippet">
          <div class="snippet-carousel" id="snippetCarousel">
            <div class="snippet-slide active">
              <p class="snippet-text">"Reliable, thorough, efficient and friendly. Highly recommend." <span class="snippet-author">- Anna C.</span> <span class="snippet-stars">&#11088;&#11088;&#11088;&#11088;&#11088;</span></p>
            </div>
            <div class="snippet-slide">
              <p class="snippet-text">"Friendly, reliable &mdash; my windows and window frames have never been so clean" <span class="snippet-author">- Elaine S.</span> <span class="snippet-stars">&#11088;&#11088;&#11088;&#11088;&#11088;</span></p>
            </div>
            <div class="snippet-slide">
            ...
            <div class="snippet-slide">
              <p class="snippet-text">"Polite, hard working, turned up on time and does a thorough job and very attentive." <span class="snippet-author">- Dan J.</span> <span class="snippet-stars">&#11088;&#11088;&#11088;&#11088;&#11088;</span></p>
            </div>
          </div>
        </div>
      ...
      <div class="col-lg-6 hero-image-col d-flex flex-column align-items-center justify-content-center mt-4 mt-lg-0 pb-5 pb-lg-0">
        <img src="/assets/images/before-after-hero-country.webp" alt="Window cleaning in Marlborough, Wiltshire" class="hero-split-img img-fluid rounded-4" />
        <p class="area-img-credit">Marlborough, Wiltshire</p>
      </div>
    </div>
  </div>
</section>
    ...
    <div class="row justify-content-center">
      <div class="col-lg-8">
        <div class="testimonial-card p-4 p-md-5 rounded-4 shadow-sm text-center">
          ...
          <p class="testimonial-card-text" style="font-size: 1.15rem;">"Jack was brilliant from start to finish. Really prompt response from the email enquiry, turned up when he said he would. He completed the job really thoroughly <strong>taking time to attend to the details.</strong> Really pleased with the result."</p>
          <p class="testimonial-card-author fw-semibold mb-0 mt-3">- Julianna Veares</p>
        </div>
      </div>
    </div>
  </div>
      ...
      <div class="col-11 col-lg-10">
        <div class="row align-items-center">
          <div class="col-md-4 mb-4 mb-md-0">
            <img src="/assets/images/jack_rectangle.webp" alt="Jack Robb - window cleaner covering Marlborough" class="img-fluid rounded-4 shadow" />
          </div>
          <div class="col-md-8">
            <div class="p-4">
              ...
              <p style="color: rgba(255,255,255,0.95); font-size: 1.1rem; line-height: 1.7;">
                Frames and sills always cleaned, corners not skipped, the kind of careful work you'd do yourself if you had the time and the kit. That's the heart of how I run J E Robb Window Cleaning. It's a small, independent local business with 150+ regular customers across Swindon, the Cotswolds and the surrounding villages, and Marlborough is part of my regular round.
              </p>
              <div class="row mt-4">
    ...
    <div class="row justify-content-center">
      <div class="col-lg-10">
        <div class="text-center mb-4">
          <h2 class="section-title">Window Cleaning Across Marlborough</h2>
          <p class="section-subtitle">From the High Street to the surrounding villages</p>
        </div>
        <p style="font-size: 1.05rem; line-height: 1.8; color: #444;">
          Marlborough has one of the widest high streets in the country and some of the most distinctive housing in Wiltshire to go with it. The streets running off the High Street are a mix of Georgian sashes, listed frontages, and older terraces, with the lanes around the College and St Peter's holding most of the period property. Out toward Manton, Preshute and the villages along the A4 you get a mix of cottages, farmhouses and newer family homes. Every property is different, so quotes are based on size, access and what you need cleaning rather than a flat rate.
        </p>
        <p style="font-size: 1.05rem; line-height: 1.8; color: #444;">
          Two things make a difference to how I work in Marlborough. The first is the period property. Older sashes and listed frontages don't take kindly to ladders against the brickwork or detergents on the masonry, so the pure water reach pole approach suits these properties well. Frames, runners and sills get cleaned as part of every visit, gently, without anything aggressive running down the stonework. The second is dust. The High Street and the A4 corridor pick up a lot of road grime, particularly through the summer, and the lanes out toward Mildenhall and Aldbourne can throw up plenty from the surrounding fields. Regular 4 or 8-weekly cleans keep on top of it before it has a chance to bake on. For three-storey properties the pole reaches the upper floors from the ground without ladders against the brickwork.
        </p>
        <div class="text-center mt-4">
          <a href="#contact" class="btn btn-primary btn-lg">Get a free quote in Marlborough</a>
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="container">
    <div class="row justify-content-center">
      <div class="col-lg-8">
        ...
        <?php
        $area_name = 'Marlborough';
        $faq_local_q = 'Do you cover the villages around Marlborough too?';
        $faq_local_a = 'Yes. Marlborough is part of Jack\'s regular round and he covers the surrounding villages too, including Mildenhall, Manton, Preshute, Fyfield, Lockeridge, West Overton, Aldbourne and the Ogbournes.';
        include '../includes/area-faqs.php';
        ?>

        <!-- Marlborough-specific FAQ -->
          ...
          <div class="accordion-item border-0 mb-3 rounded-3 shadow-sm">
            <h3 class="accordion-header">
              <button class="accordion-button collapsed fw-semibold" type="button" data-bs-toggle="collapse" data-bs-target="#faqLocal1" aria-expanded="false" aria-controls="faqLocal1">
                Do you cover the villages around Marlborough too?
              </button>
            </h3>
            <div id="faqLocal1" class="accordion-collapse collapse" data-bs-parent="#faqAccordionLocal">
              <div class="accordion-body text-muted">
                Yes. Marlborough is part of my regular round and I cover the surrounding villages too, including Mildenhall, Manton, Preshute, Fyfield, Lockeridge, West Overton, Aldbourne and the Ogbournes. Drop me a message with your postcode and I'll let you know.
              </div>
            </div>
          </div>
        </div>
  ...
  <div class="container">
    ...
    <div class="row justify-content-center">
      ...
      <div class="col-md-6 col-lg-5 mb-4">
        <div class="testimonial-card p-4 rounded-4 shadow-sm h-100">
          <div class="mb-2"><span style="color: #ffd700;">&#11088;&#11088;&#11088;&#11088;&#11088;</span></div>
          <p class="testimonial-card-text">"Jack cleans my 4 bed semi detached every 8 weeks and does a fantastic job. What I really like is his communication, <strong>messaging me the day before</strong> so I know to leave him access and close the windows. Really glad I found him and highly recommend him."</p>
...
<section id="contact" class="py-5 section-dark">
  <div class="container">
    <div class="row">
      <div class="col-12 text-center mb-4">
        <h2 class="section-title text-white">Get a Free Quote in Marlborough</h2>
      </div>
    </div>
    ...
    <div class="row justify-content-center mb-5">
      <div class="col-lg-6 text-center">
        <div class="whatsapp-cta-box p-4 p-md-5 rounded-4 shadow-sm">
          ...
          <a href="https://wa.me/447442249440?text=Hi%20Jack,%20I'd%20like%20a%20quote%20for%20window%20cleaning%20in%20Marlborough"
             target="_blank" rel="noopener"
    ...
    <div class="row justify-content-center">
      <div class="col-lg-6">
        <form id="contactForm" class="contact-form">
          <input type="hidden" id="area" name="area" value="Marlborough" />
          <input type="hidden" id="email" name="email" value="" />
          <input type="hidden" id="message" name="message" value="Enquiry from Marlborough page" />
          <div class="mb-3">
