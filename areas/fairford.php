...
<nav aria-label="breadcrumb" class="area-breadcrumb">
  <div class="container">
    <ol class="breadcrumb mb-0 py-2 small">
      ...
      <li class="breadcrumb-item active" aria-current="page">Fairford</li>
    </ol>
  </div>
</nav>
  ...
  <div class="container">
    <div class="row align-items-center min-vh-hero">
      ...
      <div class="col-lg-6 hero-text-col py-5 mt-3 mt-lg-0">
        ...
        <h1 class="hero-h1-split">Window Cleaner <br class="d-none d-md-block">in Fairford</h1>
        ...
        <div class="d-flex align-items-center mb-3">
          <img src="/assets/images/jack.webp"
            alt="Jack from J E Robb Window Cleaning - covering Fairford"
        ...
        <div class="hero-snippet">
          <div class="snippet-carousel" id="snippetCarousel">
            <div class="snippet-slide active">
              <p class="snippet-text">"Always lets me know when he's due and payment is super simple" <span class="snippet-author">- Kimberley</span> <span class="snippet-stars">&#11088;&#11088;&#11088;&#11088;&#11088;</span></p>
            </div>
            <div class="snippet-slide">
              <p class="snippet-text">"Very efficient, does the job well and very respectful of the property" <span class="snippet-author">- Harriott</span> <span class="snippet-stars">&#11088;&#11088;&#11088;&#11088;&#11088;</span></p>
            </div>
            <div class="snippet-slide">
              <p class="snippet-text">"Excellent service and great value. Windows are always sparkling clean" <span class="snippet-author">- Nicki</span> <span class="snippet-stars">&#11088;&#11088;&#11088;&#11088;&#11088;</span></p>
            </div>
            <div class="snippet-slide">
              <p class="snippet-text">"First clean off Jack. Absolutely amazing service, great attention to detail" <span class="snippet-author">- Suzanne</span> <span class="snippet-stars">&#11088;&#11088;&#11088;&#11088;&#11088;</span></p>
            </div>
          </div>
        </div>
      ...
      <div class="col-lg-6 hero-image-col d-flex flex-column align-items-center justify-content-center mt-4 mt-lg-0 pb-5 pb-lg-0">
        <img src="/assets/images/fairford.webp" alt="Window cleaning in Fairford, Gloucestershire" class="hero-split-img img-fluid rounded-4" />
        <p class="area-img-credit">Fairford, Gloucestershire</p>
      </div>
    </div>
  </div>
</section>
    ...
    <div class="row justify-content-center">
      <div class="col-lg-8">
        <div class="testimonial-card p-4 p-md-5 rounded-4 shadow-sm text-center">
          ...
          <p class="testimonial-card-text" style="font-size: 1.15rem;">"First visit from Jack and super pleased with my now clean and sparkly windows. They hadn't been professionally cleaned for a long time and were very dirty. Jack also thoroughly cleaned (never before) the over-porch hood cover. <strong>A very professional, efficient and value for money service. Have signed up for Jack to come on a regular basis</strong> and would highly recommend."</p>
          <p class="testimonial-card-author fw-semibold mb-0 mt-3">- Jane Primrose</p>
        </div>
      </div>
    </div>
  </div>
      ...
      <div class="col-11 col-lg-10">
        <div class="row align-items-center">
          <div class="col-md-4 mb-4 mb-md-0">
            <img src="/assets/images/jack_rectangle.webp" alt="Jack Robb - window cleaner covering Fairford" class="img-fluid rounded-4 shadow" />
          </div>
          <div class="col-md-8">
            <div class="p-4">
              ...
              <p style="color: rgba(255,255,255,0.95); font-size: 1.1rem; line-height: 1.7;">
                Frames and sills always cleaned, corners not skipped, the kind of careful work you'd do yourself if you had the time and the kit. That's the heart of how I run J E Robb Window Cleaning. It's a small, independent local business with 150+ regular customers across Swindon, the Cotswolds and the surrounding villages, and Fairford is part of my regular round.
              </p>
              <div class="row mt-4">
    ...
    <div class="row justify-content-center">
      <div class="col-lg-10">
        <div class="text-center mb-4">
          <h2 class="section-title">Window Cleaning Across Fairford</h2>
          <p class="section-subtitle">From the Market Place to the lanes around the town</p>
        </div>
        <p style="font-size: 1.05rem; line-height: 1.8; color: #444;">
          Fairford sits where the Cotswolds meet the upper Thames valley, and the housing reflects that. The streets around the Market Place and St Mary's are mostly Cotswold stone cottages and older terraces, with larger period homes along the High Street and the lanes that run down toward the river Coln. Out toward the edges of town and the surrounding lanes there's more variety, from postwar bungalows to newer family homes on the estates near the airfield. Every property is different, so quotes are based on size, access and what you need cleaning rather than a flat rate.
        </p>
        <p style="font-size: 1.05rem; line-height: 1.8; color: #444;">
          Two things make a difference to how I work in Fairford. The first is the stone. Older Cotswold limestone is porous and the lime mortar around it doesn't appreciate being soaked in detergents, so the pure water reach pole approach suits these properties well. Frames and sills get cleaned as part of every visit, gently, without anything aggressive running down the stonework. The second is dust. RAF Fairford brings periods of heavier activity, particularly around the Air Tattoo, and the lanes out toward Kempsford and Whelford can throw up a fair amount from the fields in summer. Regular 8-weekly cleans keep on top of it before grime has a chance to bake on. For three-storey properties the pole reaches the upper floors from the ground without ladders against the brickwork.
        </p>
        <div class="row mt-4 g-3">
          <div class="col-sm-6">
            <img src="/assets/images/south-cerney.webp"
                 alt="Cotswold stone property near Fairford"
          ...
          <div class="col-sm-6">
            <img src="/assets/images/south-cerney-the-landings.webp"
                 alt="Residential property near Fairford, Gloucestershire"
                 class="img-fluid rounded-4 shadow-sm w-100" style="object-fit: cover; max-height: 260px;" />
          </div>
        </div>
        <div class="text-center mt-4">
          <a href="#contact" class="btn btn-primary btn-lg">Get a free quote in Fairford</a>
        </div>
      </div>
    </div>
  </div>
...
<!-- Schema for the Fairford-specific FAQ only -->
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "Do you cover the lanes and villages around Fairford too?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Yes. Fairford is part of Jack's regular round, so he's in the area often. He covers properties on the lanes around the town as well."
      }
    }
  ]
}
    ...
    <div class="row justify-content-center">
      <div class="col-md-6 col-lg-5 mb-4">
        <div class="testimonial-card p-4 rounded-4 shadow-sm h-100">
          ...
          <p class="testimonial-card-text">"Our first window clean by Jack. He did an excellent job, really took the time to ensure the <strong>windows, surrounds and sills were very well cleaned.</strong> I'm very pleased indeed and would happily recommend him."</p>
          <p class="testimonial-card-author fw-semibold mb-0">- Sue Whelan</p>
        </div>
      </div>
      <div class="col-md-6 col-lg-5 mb-4">
        <div class="testimonial-card p-4 rounded-4 shadow-sm h-100">
          <div class="mb-2"><span style="color: #ffd700;">&#11088;&#11088;&#11088;&#11088;&#11088;</span></div>
          <p class="testimonial-card-text">"A very professional service. <strong>Jack has been cleaning our windows for 5 years</strong> and has provided a reliable and efficient service. He shows <strong>pride in his work</strong> and is always courteous and helpful."</p>
...
<section id="contact" class="py-5 section-dark">
  <div class="container">
    <div class="row">
      <div class="col-12 text-center mb-4">
        <h2 class="section-title text-white">Get a Free Quote in Fairford</h2>
      </div>
    </div>
