  ...
  <div class="container">
    <div class="row align-items-center min-vh-hero">
        ...
        <div class="hero-snippet">
          <div class="snippet-carousel" id="snippetCarousel">
            <div class="snippet-slide active">
              <p class="snippet-text">"Looking forward to his 2nd visit" <span class="snippet-author">- Debbie</span> <span class="snippet-stars">&#11088;&#11088;&#11088;&#11088;&#11088;</span></p>
            </div>
            <div class="snippet-slide">
              <p class="snippet-text">"Communication is great, great value for money" <span class="snippet-author">- Tamsin</span> <span class="snippet-stars">&#11088;&#11088;&#11088;&#11088;&#11088;</span></p>
            </div>
            <div class="snippet-slide">
              <p class="snippet-text">"Professional, polite, clean and tidy from the beginning" <span class="snippet-author">- Tracey</span> <span class="snippet-stars">&#11088;&#11088;&#11088;&#11088;&#11088;</span></p>
            </div>
            <div class="snippet-slide">
      ...
      <div class="col-lg-6 hero-image-col d-flex flex-column align-items-center justify-content-center mt-4 mt-lg-0 pb-5 pb-lg-0">
        <img src="/assets/images/clean-domestic-window.webp" alt="Window cleaning in Swindon and Wiltshire" class="hero-split-img img-fluid rounded-4" />
      </div>
    </div>
  </div>
</section>
...
<div class="trust-static">
  <div class="container">
    <ul class="trust-static-list">
      ...
      <li><i class="fas fa-map-marker-alt"></i> Swindon &amp; Wiltshire</li>
    ...
    <div class="row justify-content-center">
      <div class="col-md-6 col-lg-4 mb-4">
        <div class="testimonial-card p-4 rounded-4 shadow-sm h-100">
          ...
          <p class="testimonial-card-text">"Jack was very thorough on our 1st clean. <strong>He provides a friendly professional service. Looking forward to his 2nd visit.</strong>"</p>
          <p class="testimonial-card-author fw-semibold mb-0">- Debbie Merifield</p>
        </div>
      </div>
      <div class="col-md-6 col-lg-4 mb-4">
        <div class="testimonial-card p-4 rounded-4 shadow-sm h-100">
          <div class="mb-2"><span style="color: #ffd700;">&#11088;&#11088;&#11088;&#11088;&#11088;</span></div>
          <p class="testimonial-card-text">"Jack is fantastic. <strong>Communication is great, he's always polite and friendly and it's great value for money too!</strong>"</p>
          <p class="testimonial-card-author fw-semibold mb-0">- Tamsin Christofides</p>
        </div>
      </div>
      <div class="col-md-6 col-lg-4 mb-4">
        <div class="testimonial-card p-4 rounded-4 shadow-sm h-100">
          <div class="mb-2"><span style="color: #ffd700;">&#11088;&#11088;&#11088;&#11088;&#11088;</span></div>
          <p class="testimonial-card-text">"Jack has been very professional, polite, clean and tidy from the beginning. <strong>Jack let me know which day he'd be arriving.</strong>"</p>
          <p class="testimonial-card-author fw-semibold mb-0">- Tracey Fordom</p>
        </div>
      </div>
    </div>
    <div class="row">
    ...
    <div class="row justify-content-center">
      <div class="col-lg-6">
        <form id="contactForm" class="contact-form">
          <input type="hidden" id="area" name="area" value="Other / Area Check" />
          <input type="hidden" id="email" name="email" value="" />
          <input type="hidden" id="message" name="message" value="Enquiry from Other Areas page - checking coverage" />
          <div class="mb-3">
