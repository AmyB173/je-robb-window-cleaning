...
<!--
  ...
  component styles are shared from style.css (see the "V2 REDESIGN
  COMPONENT LIBRARY" section) - nothing page-specific defined here.
  Copy and area-specific facts unchanged from the original page.
-->
  ...
  <div class="container">
    ...
    <div class="row align-items-center g-5">
      <div class="col-lg-6">
        ...
        <h1>Window Cleaner <br class="d-none d-md-block">in Wroughton</h1>
        ...
        <div class="v2-hero-credential">
          <img src="/assets/images/jack.webp" alt="Jack from J E Robb Window Cleaning - based in Wroughton" />
          <span><strong class="text-white">Jack Robb</strong> &middot; I live in Wroughton</span>
        </div>
      </div>
      <div class="col-lg-6">
        <div class="v2-hero-img-wrap">
          <img src="/assets/images/clean-domestic-window.webp" alt="Window cleaning in Wroughton" class="v2-hero-img" />
        </div>
        <p class="area-img-credit text-center">Wroughton, Wiltshire</p>
      </div>
    </div>
  </div>
</section>
...
<div class="container">
  <div class="v2-trust-card v2-reveal">
    <ul class="v2-trust-list">
      <li><i class="fas fa-map-marker-alt"></i><span>I Live in Wroughton</span></li>
    ...
    <div class="row align-items-center g-5">
      <div class="col-lg-5">
        <div class="v2-jack-photo-wrap v2-reveal">
          <img src="/assets/images/jack_rectangle.webp" alt="Jack Robb - window cleaner who lives in Wroughton" class="v2-jack-photo" />
          <div class="v2-jack-tag">
            <span class="v2-jack-tag-num">SN4</span>
            <span class="v2-jack-tag-label">Wroughton Local</span>
          </div>
        </div>
      </div>
      <div class="col-lg-7">
        <div class="v2-reveal">
          ...
          <h2 class="v2-heading on-dark">I Live Here Too</h2>
          ...
          <ul class="meet-jack-list">
            ...
            <li><i class="fas fa-map-marker-alt"></i><span>A Wroughton local. I know the village and my customers by name.</span></li>
            <li><i class="fas fa-shield-alt"></i><span>Reputation matters here. Known locally for thorough, careful work.</span></li>
          </ul>
        </div>
      </div>
    </div>
...
<section class="v2-section" id="local-knowledge" style="background: var(--v2-soft-teal);">
  <div class="container">
    <div class="text-center v2-section-head mx-auto mb-5 v2-reveal">
      ...
      <h2 class="v2-heading">Window Cleaning Across Wroughton</h2>
      <p class="v2-lede">From the village core to the lanes out toward Barbury.</p>
    </div>
    <div class="v2-reveal">
      <p class="v2-lede mb-4">
        Wroughton's a real mix - older cottages and stone properties around the High Street and the church, terraced rows along Markham Road and the Square, the bigger 70s and 80s estates off Inverary Road and Overbrook, and the newer builds out toward Wharf Road. Each one has its own quirks, and after years of working the village, I know them all.
      </p>
      <p class="v2-lede mb-0">
        The pure water fed pole system reaches first and second-floor windows from the ground without leaning ladders against your property most of the time. That matters more than people realise - older Wroughton homes often have softer paintwork and stonework that ladders can mark, and many of the newer estates have a lot of glass at first floor that's awkward to reach any other way. Frames and sills get cleaned as part of every visit. A regular 8-weekly clean keeps on top of it before it has a chance to bake on.
      </p>
    </div>
    <div class="row g-4 mt-2 v2-local-grid v2-reveal">
      <div class="col-sm-6">
        <img src="/assets/images/sn4-house-with-van.webp" alt="Jack's van outside a Wroughton property" loading="lazy" decoding="async" />
      </div>
      <div class="col-sm-6">
        <img src="/assets/images/sn4-conservatory.webp" alt="Conservatory window cleaning in Wroughton, SN4" loading="lazy" decoding="async" />
      </div>
    </div>
    <div class="text-center mt-5 v2-reveal">
      <a href="#contact" class="cta-text-link">Get a free quote in Wroughton <span class="cta-arrow">&rarr;</span></a>
    </div>
  </div>
</section>

<?php
$v2_services_heading = 'Window Cleaning Services in Wroughton';
...
<section class="v2-section section-dark" id="contact">
  <div class="container">
    <div class="text-center v2-section-head mx-auto mb-5 v2-reveal">
      ...
      <h2 class="v2-heading on-dark">Get a Free Quote in Wroughton</h2>
    </div>
