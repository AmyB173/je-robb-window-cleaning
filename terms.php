        ...
        <div class="col-lg-8 py-5">
          ...
          <div class="p-4 rounded-4 mb-5" style="background: #f0f7ff; border-left: 4px solid #0a5ca0;">
            ...
            <ul style="font-size: 0.95rem; line-height: 1.8; color: #444; padding-left: 1.25rem;">
              ...
              <li><strong>Access needed.</strong> Jack needs clear access to your windows. He'll message you the day before each clean so you can prepare.</li>
              <li><strong>Insured.</strong> Jack holds public liability insurance for your peace of mind.</li>
              <li><strong>Price changes.</strong> Jack will always give you at least 8 weeks' notice before any price increase, so you'll know before your next clean.</li>
              <li><strong>Your data is safe.</strong> Jack only uses your details to provide the service and communicate with you. Nothing is shared with third parties.</li>
            </ul>
            <p style="font-size: 0.9rem; color: #666; margin-bottom: 0;">
              The full terms are set out below. If you have any questions, just get in touch.
            </p>
          </div>
          ...
          <h2 class="brand-blue" style="font-size: 1.5rem; margin-top: 2.5rem; margin-bottom: 0.5rem;">Full Terms and Conditions</h2>
          ...
          <ul>
            ...
            <li>Gutter emptying</li>
            <li>Commercial window cleaning</li>
          </ul>
          <p>Jack uses a pure water fed pole system for exterior window cleaning. This method uses purified water with no chemicals or detergents, making it safe for people, pets, plants and the environment. Windows, frames and sills are cleaned as part of every visit. Surfaces are left to dry naturally, and because the water is purified, it dries without leaving any marks.</p>
          <p>For tougher jobs such as builders' residue (plaster, cement, paint etc.), Jack may use light cleaning products alongside the pure water system. If your windows need this kind of attention, just let him know and he can advise on the best approach.</p>
          ...
          <ul>
            ...
            <li>Closing all windows and doors before the clean</li>
            <li>Ensuring the area around windows is reasonably clear of obstructions such as garden furniture, plant pots or bins</li>
            <li>Keeping pets and small children safely away from the work area during the clean</li>
          </ul>
          <p>If access is not available on the day of the clean and Jack has not been given prior notice, he will clean all accessible windows. You may be charged for the partial clean.</p>
          <p>Jack will not move personal belongings, garden furniture or other items to gain access. If items are blocking access to certain windows, those windows will not be cleaned on that visit.</p>
          ...
          <ul>
            <li>Faulty or poorly fitted window seals, beading, or trims</li>
            <li>Rotting or deteriorating window frames</li>
            <li>Loose decorative bars or lead strips stuck to glass</li>
            <li>Cracked, chipped or damaged glass</li>
            <li>Flaking paint, oxidised uPVC or failing sealant</li>
            <li>Loose or poorly secured fascias, soffits or guttering</li>
          </ul>
          <p>If Jack notices any issues with your windows or property during a clean, he will let you know.</p>
          ...
          <div class="mt-5 p-4 bg-light rounded-4 text-center">
            <h3 class="brand-blue">Any Questions?</h3>
            <p>If anything in these terms isn't clear, Jack is happy to explain. Just get in touch.</p>
